...
exports.createProcessor = function(filter, msgfunction) {
	return new Processor(filter, msgfunction);
}

function Processor(filter, msgfunction)
{
	this.filter = filter;
	this.processors = [];

    if (msgfunction)
        this.on('message', msgfunction);
}
...
Processor.prototype.createProcessor = function (filter, msgfunction)
{
	var processor = new Processor(filter, msgfunction);
